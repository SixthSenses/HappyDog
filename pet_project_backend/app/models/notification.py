...
class NotificationType(Enum):
    ...
    # 확장 타입 (기획 제안 반영)
    CARTOON_PROGRESS = "CARTOON_PROGRESS"
    CARTOON_COMPLETED = "CARTOON_COMPLETED"
    PET_CARE_GOAL_REACHED = "PET_CARE_GOAL_REACHED"
    PET_CARE_DAILY_SUMMARY = "PET_CARE_DAILY_SUMMARY"
